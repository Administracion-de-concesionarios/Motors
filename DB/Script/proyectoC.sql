...
CREATE TABLE IF NOT EXISTS concesionarios.GC_EMPLEADO (
    ...
    CONSTRAINT fk_GC_EMPLEADO_GC_CONCESIONARIO1 FOREIGN KEY (GC_CONCESIONARIO_CON_ID)
        REFERENCES concesionarios.GC_CONCESIONARIO (CON_ID)
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_USUARIO (
    ...
    CONSTRAINT fk_GC_USUARIO_GC_EMPLEADO1 FOREIGN KEY (GC_EMPLEADO_EMP_ID)
        REFERENCES concesionarios.GC_EMPLEADO (EMP_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_VENTA (
    ...
    CONSTRAINT fk_GC_VENTA_GC_CLIENTE1 FOREIGN KEY (GC_CLIENTE_CLI_ID)
        REFERENCES concesionarios.GC_CLIENTE (CLI_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_FACTURA (
    ...
    CONSTRAINT fk_GC_FACTURA_GC_USUARIO1 FOREIGN KEY (GC_USUARIO_USR_ID)
        REFERENCES concesionarios.GC_USUARIO (USR_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_GC_FACTURA_GC_VENTA1 FOREIGN KEY (GC_VENTA_VEN_ID)
        REFERENCES concesionarios.GC_VENTA (VEN_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_MODELO (
    ...
    CONSTRAINT fk_GC_MODELO_GC_MARCA1 FOREIGN KEY (GC_MARCA_MAR_ID)
        REFERENCES concesionarios.GC_MARCA (MAR_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_GC_MODELO_GC_CATALOGO1 FOREIGN KEY (GC_CATALOGO_CAT_ID)
        REFERENCES concesionarios.GC_CATALOGO (CAT_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_VEHICULO (
    ...
    CONSTRAINT fk_GC_VEHICULO_GC_MODELO1 FOREIGN KEY (GC_MODELO_MOD_ID)
        REFERENCES concesionarios.GC_MODELO (MOD_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_GC_VEHICULO_GC_VENTA1 FOREIGN KEY (GC_VENTA_VEN_ID)
        REFERENCES concesionarios.GC_VENTA (VEN_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE IF NOT EXISTS concesionarios.GC_MODELO_has_GC_CARACTERISTICA (
    ...
    CONSTRAINT fk_GC_MODELO_has_GC_CARACTERISTICA_GC_CARACTERISTICA1 FOREIGN KEY (GC_CARACTERISTICA_CAR_ID)
        REFERENCES concesionarios.GC_CARACTERISTICA (CAR_ID)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
CREATE TABLE concesionarios.GC_DESCUENTOS (
    ...
    FAC_ID INT(10),
    PRIMARY KEY (DES_ID),
    CONSTRAINT FK_GC_DESCUENTOS FOREIGN KEY (DES_FACTURAID)
        REFERENCES concesionarios.gc_factura (FAC_ID)
);
